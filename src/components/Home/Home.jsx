            ...
            <div className="row d-flex justify-content-between align-items-center">
                ...
                <div className="col-12 col-md-4 text-center text-md-start mb-4">
                    <h5 className="text-muted">Disfrutá tu tiempo
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-alarm mx-2" viewBox="0 0 16 16">
                ...
                <div className="col-12 col-md-4 text-center mb-4">
                    <h5 className="text-muted">Cuotas sin interés
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-credit-card mx-2" viewBox="0 0 16 16">
                ...
                <div className="col-12 col-md-4 text-center text-md-end mb-4">
                    <h5 className="text-muted">Ofertas exclusivas
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-tags mx-2" viewBox="0 0 16 16">
